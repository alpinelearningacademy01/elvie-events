      ...
      <div className="grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2">
          ...
          <p className="mt-4 max-w-md text-sm text-white/70">
            VenueWise connects organizers with the GCC's largest curated network
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm">
            <li>
              <a href="#explore" className="hover:text-elvie-gold vw-transition">
                Explore venues
              </a>
            </li>
            <li>
              <a href="#advisor" className="hover:text-elvie-gold vw-transition">
                Ask a venue advisor
              </a>
            </li>
            <li>
              <Link to="/login" className="hover:text-elvie-gold vw-transition">
                Create an account
              </Link>
            </li>
          </ul>
          ...
          <div className="mt-6 flex gap-3">
            {[Instagram, Linkedin, XIcon].map((Icon, i) => (
              <a
                key={i}
                href="#"
                className="grid h-9 w-9 place-items-center rounded-full border border-white/15 vw-transition hover:border-elvie-gold hover:text-elvie-navy-deep"
                style={{ "--hover-bg": "hsl(var(--elvie-gold))" } as React.CSSProperties}
